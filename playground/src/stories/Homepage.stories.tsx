...
export const CSSLessonsComingSoon: Story = {
  play: async ({ canvasElement }) => {
    // CSS lessons should have "Coming Soon" badges (9 incomplete)
    // Plus 1 "Under Development" badge on the course card = 10 total warning badges
    const comingSoonBadges = canvasElement.querySelectorAll('.badge-warning');
    expect(comingSoonBadges.length).toBeGreaterThanOrEqual(9);
  },
};
