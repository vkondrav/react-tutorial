// ============================================
// ComponentRulesDemo - The 3 Component Rules
// ============================================
...
function RuleDetail({ rule, onClose }: RuleDetailProps): React.ReactElement {
  ...
  return (
    <div className="card bg-base-200 overflow-hidden">
      ...
      <div className="p-6">
        ...
        >
          <CodeSnippet
            code={showCorrect ? rule.correct.code : rule.wrong.code}
            language="tsx"
            showCopy={false}
          />
        </div>
...
export default function ComponentRulesDemo(): React.ReactElement {
