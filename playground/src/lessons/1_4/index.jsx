    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <Section title="🧱 What is a Component?">
        <p className="text-slate-400 leading-relaxed">
          A <strong className="text-blue-500">component</strong> is a reusable piece of UI. Think of
      ...
      <Section title="🧩 Component Composition">
        <p className="text-slate-400 leading-relaxed">
          ...
          <strong className="text-green-500">composition</strong>. It's how you build complex UIs
          from simple pieces:
        </p>
        <CompositionDemo />
      </Section>
