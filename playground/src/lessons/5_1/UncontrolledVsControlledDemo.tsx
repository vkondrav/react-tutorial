      ...
      <div className="card bg-base-300 p-5">
          ...
          <table className="table table-sm">
            ...
            <tbody>
              <tr>
                ...
                <td><HiX className="text-error" size={16} /></td>
                <td><HiCheck className="text-success" size={16} /></td>
              </tr>
              <tr>
        ...
        <div className="mt-4 flex items-start gap-2 text-sm bg-success/10 rounded-lg p-3">
          ...
          <p className="text-base-content/70">
            <strong className="text-success">React recommends controlled components</strong> for most cases.
            They give you full control over your form data and enable powerful features like
