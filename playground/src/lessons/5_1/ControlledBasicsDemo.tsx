      ...
      <div className="card bg-base-300 p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-base-100 rounded-lg p-4 border border-base-300">
            ...
            <div className="text-xl">
              {name ? (
                <span>Hello, <strong className="text-primary">{name}</strong>! 👋</span>
              ) : (
        ...
        <div className="mt-4 flex items-start gap-2 text-sm bg-primary/10 rounded-lg p-3">
          ...
          <p className="text-base-content/70">
            Notice how the preview updates <strong className="text-primary">instantly</strong> as you type.
            This is the power of controlled components — React always knows the current value!
          </p>
        </div>
      </div>
