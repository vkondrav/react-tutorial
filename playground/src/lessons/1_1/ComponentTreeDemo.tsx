// ============================================
// ComponentTreeDemo - Component Composition Tree
// ============================================
...
type ComponentColor = 'blue' | 'violet' | 'emerald' | 'amber' | 'pink';
...
const colorVariants: Record<ComponentColor, string> = {
  blue: 'btn-primary',
...
const borderClasses: Record<ComponentColor, string> = {
  blue: 'border-primary',
...
export default function ComponentTreeDemo(): React.ReactElement {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Info Card */}
      <div
        className={`card bg-base-200 p-5 min-h-[80px] border-2 ${
          selectedComp ? borderClasses[selectedComp.color] : 'border-base-300'
        }`}
      >
        {selectedComp ? (
          <div>
