    ...
    <div style={{
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <div style={{
          ...
          <span style={{ color: '#64748b' }}>{'// Style changes based on condition'}</span><br/>
      ...
      <div>
        ...
        <div style={{
          ...
          <span style={{ color: '#64748b' }}>{'// Nested ternaries (use sparingly!)'}</span><br/>
      ...
      <div style={{
        ...
        <div style={{ fontSize: '0.9rem', lineHeight: 1.6, color: '#fde68a' }}>
          While nested ternaries work, they can get hard to read quickly.
          For many conditions, consider extracting to a variable or using early returns instead!
        </div>
      </div>
    </div>
  );
